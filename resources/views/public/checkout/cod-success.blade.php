...
<div class="min-h-screen bg-gray-950 flex items-center justify-center px-4 py-16">
    <div class="max-w-lg w-full">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-black text-white tracking-tight mb-2">Order Placed!</h1>
            <p class="text-gray-400 text-sm leading-relaxed">
                Thank you for your order. You've selected <span class="text-white font-semibold">Cash on Delivery</span>.<br>
                A confirmation email has been sent to <span class="text-white font-semibold">{{ $order->shipping_email }}</span>
            </p>
        </div>
        ...
        <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden mb-6">
            <div class="bg-green-500/10 border-b border-green-500/15 px-6 py-4 flex items-center justify-between">
                ...
                <span class="px-3 py-1 bg-yellow-500/15 border border-yellow-500/20 text-yellow-400 text-xs font-bold rounded-full">
                    Pending Payment
                </span>
            </div>

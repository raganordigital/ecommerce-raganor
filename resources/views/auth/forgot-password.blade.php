...
<div class="auth-wrap min-h-screen bg-gray-950 flex items-center justify-center px-4 relative overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-md">
        ...
        <div class="fade-up bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8" style="animation-delay:0.05s">
            ...
            <div class="mb-6">
                <h1 class="text-2xl font-black text-white mb-2">Forgot your password?</h1>
                <p class="text-sm text-gray-400 leading-relaxed">No problem. Enter your email and we'll send you a reset link right away.</p>
            </div>
            @if(session('status'))
                <div class="flex items-center gap-2.5 bg-green-500/10 border border-green-500/20 text-green-400 text-sm font-medium px-4 py-3 rounded-xl mb-5">
            ...
            <p class="text-center text-sm text-gray-500 mt-6">
                Remember your password? <a href="{{ route('login') }}" class="text-white font-semibold hover:text-amber-400 transition-colors ml-1">Back to sign in →</a>
            </p>
        </div>
    </div>
</div>

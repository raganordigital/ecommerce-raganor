                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            <form wire:submit.prevent="processCheckout">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="text" 
                                                   ...
                                                   class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors @error('shipping_name') border-red-300 @enderror"
                                        ...
                                        <div>
                                            ...
                                            <input type="email" 
                                                   ...
                                                   class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors @error('shipping_email') border-red-300 @enderror"
                                        ...
                                        <div>
                                            ...
                                            <input type="tel" 
                                                   ...
                                                   class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors @error('shipping_phone') border-red-300 @enderror"
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div class="md:col-span-2">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors @error('shipping_address') border-red-300 @enderror"
                                        ...
                                        <div>
                                            ...
                                            <input type="text" 
                                                   ...
                                                   class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors @error('shipping_city') border-red-300 @enderror"
                                        ...
                                        <div>
                                            ...
                                            <input type="text" 
                                                   ...
                                                   class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors @error('shipping_state') border-red-300 @enderror"
                                                   placeholder="NY">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" 
                                                   ...
                                                   class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors @error('shipping_zipcode') border-red-300 @enderror"
                                                   placeholder="10001"
                                                   required>
                                        ...
                                        <div>
                                            ...
                                            <select id="shipping_country" 
                                                    ...
                                                    class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors @error('shipping_country') border-red-300 @enderror"
                                                    required>
                                ...
                                <!-- Submit Button -->
                                <button type="submit" 
                                        class="w-full {{ $checkoutType == 'buy_now' ? 'bg-green-600 hover:bg-green-700' : 'bg-blue-600 hover:bg-blue-700' }} text-white py-4 px-6 rounded-lg font-medium transition-colors flex items-center justify-center group"

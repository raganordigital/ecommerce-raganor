...
<div class="container mx-auto px-4 py-6">
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex space-x-2">
            <a href="{{ route('admin.products.edit', $product) }}" class="bg-yellow-600 hover:bg-yellow-700 text-white py-2 px-4 rounded-lg transition duration-200">
                <i class="fas fa-edit mr-2"></i>Edit
            </a>
            <a href="{{ route('admin.products.index') }}" class="bg-gray-600 hover:bg-gray-700 text-white py-2 px-4 rounded-lg transition duration-200">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="font-medium">{{ $product->tax_rate ? $product->tax_rate.'%' : 'N/A' }}</p>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="relative {{ $image->is_primary ? 'ring-2 ring-blue-500 rounded-lg' : '' }}">
                        <img src="{{ Storage::url($image->thumbnail_path) }}" alt="{{ $image->alt_text ?: $product->name }}" class="w-full h-24 object-cover rounded-lg">
                        @if($image->is_primary)

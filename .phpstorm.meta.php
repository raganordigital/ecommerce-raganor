...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\xampp\htdocs\ecommerce-raganor\public\storage' => 'string',
            ...
            'logviewer.max_file_size' => 'integer',
            'logviewer.pattern' => 'string',
            'logviewer.storage_path' => 'string',
            'mail.default' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.D:\\xampp\\htdocs\\ecommerce-raganor\\public\\storage','livewire.component_locations','livewire.component_namespaces.layouts','livewire.component_namespaces.pages',
...
'logging.channels.browser.driver','logging.channels.browser.path','logging.channels.browser.level','logging.channels.browser.days','logviewer.max_file_size',
'logviewer.pattern','logviewer.storage_path','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme',
...
'session.http_only','session.same_site','session.partitioned','debugbar.enabled','debugbar.collect_jobs',
...
'boost.executable_paths.vendor_bin','cashier.key','cashier.secret','cashier.path','cashier.webhook.secret',
'cashier.webhook.tolerance','cashier.webhook.events','cashier.currency','cashier.currency_locale','cashier.payment_notification',
'cashier.invoices.renderer','cashier.invoices.options.paper','cashier.invoices.options.remote_enabled','cashier.logger','mcp.redirect_domains',
...
'activitylog.activity_model','activitylog.table_name','activitylog.database_connection','sitemap.guzzle_options.cookies','sitemap.guzzle_options.connect_timeout',
...
'boost.browser-logs','cashier.payment','cashier.webhook','default-livewire.update','livewire.upload-file','livewire.preview-file','home','products.index',
'products.show','register','login',
...
'logout','admin.dashboard','admin.dashboard','admin.products.index','admin.products.create',
'admin.products.store','admin.products.show','admin.products.edit','admin.products.update','admin.products.destroy',
'admin.products.toggle-status','admin.products.toggle-featured','admin.products.images.delete','admin.products.images.reorder','admin.categories.index',
'admin.categories.create','admin.categories.store','admin.categories.show','admin.categories.edit','admin.categories.update',
'admin.categories.destroy','admin.orders.index','admin.orders.create','admin.orders.store','admin.orders.show',
'admin.orders.edit','admin.orders.update','admin.orders.destroy','admin.orders.update-status','storage.local',
'storage.local.upload',);
        registerArgumentsSet('views', 
'8638ec33c61cc525dd2e9169f86862e0::cart.cart-counter','8638ec33c61cc525dd2e9169f86862e0::cart.cart-dropdown','8638ec33c61cc525dd2e9169f86862e0::cart.cart-page','8638ec33c61cc525dd2e9169f86862e0::product.add-to-cart','297912d7ee8b141eb73dd82db0158b55::application-logo',
'297912d7ee8b141eb73dd82db0158b55::auth-session-status','297912d7ee8b141eb73dd82db0158b55::danger-button','297912d7ee8b141eb73dd82db0158b55::dropdown','297912d7ee8b141eb73dd82db0158b55::dropdown-link','297912d7ee8b141eb73dd82db0158b55::input-error',
'297912d7ee8b141eb73dd82db0158b55::input-label','297912d7ee8b141eb73dd82db0158b55::layouts.footer','297912d7ee8b141eb73dd82db0158b55::layouts.navigation','297912d7ee8b141eb73dd82db0158b55::modal','297912d7ee8b141eb73dd82db0158b55::nav-link',
'297912d7ee8b141eb73dd82db0158b55::primary-button','297912d7ee8b141eb73dd82db0158b55::responsive-nav-link','297912d7ee8b141eb73dd82db0158b55::secondary-button','297912d7ee8b141eb73dd82db0158b55::text-input','admin.categories.create',
'admin.categories.edit','admin.categories.index','admin.dashboard.index','admin.layouts.admin','admin.orders.index',
'admin.orders.show','admin.products.create','admin.products.edit','admin.products.index','admin.products.show',
'application-logo','auth-session-status','auth.confirm-password','auth.forgot-password','auth.login',
'auth.register','auth.reset-password','auth.verify-email','cart.cart-counter','cart.cart-dropdown',
'cart.cart-page','components.application-logo','components.auth-session-status','components.danger-button','components.dropdown',
'components.dropdown-link','components.input-error','components.input-label','components.layouts.footer','components.layouts.navigation',
...
'components.text-input','danger-button','dashboard','dropdown','dropdown-link',
'emails.orders.placed','emails.orders.status-updated','f4ac99e09542ff494432bc959d4fee61::app','f4ac99e09542ff494432bc959d4fee61::guest','f4ac99e09542ff494432bc959d4fee61::navigation',
'input-error','input-label','laravel-log-viewer::log','layouts.app','layouts.footer',
'layouts.guest','layouts.navigation','layouts.navigation','layouts::app','layouts::guest',
'layouts::navigation','livewire.cart.cart-counter','livewire.cart.cart-dropdown','livewire.cart.cart-page','livewire.product.add-to-cart',
'modal','nav-link','primary-button','product.add-to-cart','profile.edit',
'profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','public.cart.index','public.checkout.index',
'public.checkout.success','public.products.index','public.products.show','public.wishlist.index','responsive-nav-link',
'secondary-button','text-input','vendor.laravel-log-viewer.log','welcome','cashier::invoice',
'cashier::payment','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line','laravel-exceptions-renderer::components.formatted-source',
...
'laravel-exceptions::minimal','laravel-log-viewer::log','livewire::bootstrap','livewire::simple-bootstrap','livewire::simple-tailwind',
...
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'D:.xampp.htdocs.ecommerce-raganor.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
